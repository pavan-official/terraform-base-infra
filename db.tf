...
resource "aws_db_subnet_group" "prod_subnet_group" {
  ...
  subnet_ids = [aws_subnet.Public-Subnet1-Terraform.id, aws_subnet.Public-Subnet2-Terraform.id, aws_subnet.Public-Subnet3-Terraform.id] # Replace with your actual subnet IDs
